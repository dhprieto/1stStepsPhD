...
urineAntImp <- impute_cart(dat = urineAnt, formula = CA+ CA.Gluc+ DHPAA+ DHPAA.Gluc + DHPAA.Gluc.Sulfate + DHPAA.di.Sulfate + Total.DHPAA + TFA.Gluc + TFA.Sulfate+ VA+ VA.GG +  VA.Gluc.Sulfate+ VA.di.Sulfate
                           ~ Sweetener + Sex + Time + Total.TFA+Total.VA)

urineAntImp$Total.CA
