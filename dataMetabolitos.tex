...
\FunctionTok{qqnorm}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"SA"}\NormalTok{,}\StringTok{"mean"}\NormalTok{], }\AttributeTok{main =} \StringTok{"SA"}\NormalTok{)}
\FunctionTok{qqline}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"SA"}\NormalTok{,}\StringTok{"mean"}\NormalTok{])}
\FunctionTok{qqnorm}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"ST"}\NormalTok{,}\StringTok{"mean"}\NormalTok{], }\AttributeTok{main =}  \StringTok{"ST"}\NormalTok{)}
\FunctionTok{qqline}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"ST"}\NormalTok{,}\StringTok{"mean"}\NormalTok{])}
\FunctionTok{qqnorm}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"SA"}\NormalTok{,}\StringTok{"mean"}\NormalTok{], }\AttributeTok{main =} \StringTok{"SU"}\NormalTok{)}
\FunctionTok{qqline}\NormalTok{(fenFlavTotal[fenFlavTotal}\SpecialCharTok{$}\NormalTok{Endulzante }\SpecialCharTok{==} \StringTok{"SU"}\NormalTok{,}\StringTok{"mean"}\NormalTok{])}
\end{Highlighting}
\end{Shaded}

\includegraphics{dataMetabolitos_files/figure-latex/normalidad-1.pdf}
...
\includegraphics{dataMetabolitos_files/figure-latex/2way-ANOVA-1.pdf}
\includegraphics{dataMetabolitos_files/figure-latex/2way-ANOVA-2.pdf}
...
\includegraphics{dataMetabolitos_files/figure-latex/2way-ANOVA-3.pdf}
\includegraphics{dataMetabolitos_files/figure-latex/2way-ANOVA-4.pdf}
